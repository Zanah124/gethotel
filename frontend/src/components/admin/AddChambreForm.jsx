...
const AddChambreForm = () => {
  ...
  // Charger les types de chambres au montage
  useEffect(() => {
    fetchTypesChambre();
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post('/admin/chambres', payload);
      ...
      if (err.response?.data?.message) {
        ...
        setError('Erreur lors de l\'ajout de la chambre. Réessayez.');
      }
    } finally {
      setLoading(false);
    }
    ...
    return (
      <div className="p-6 max-w-2xl mx-auto">
        <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-green-800 mb-2">Chambre créée avec succès !</h2>
          <p className="text-green-600 mb-4">
            La chambre {form.numero_chambre} a été ajoutée.
          </p>
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Remplissez les informations de la nouvelle chambre</p>
      </div>
            ...
            <div className="md:col-span-2">
              ...
              {loadingTypes ? (
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  ...
                  >
                    → Retour au dashboard pour créer des types
                  </button>
                </div>
              ) : (
                <div className="relative">
